...
Cloud-only via WebDAV - no local file/PR logging.
"""
import logging
...
from hei_datahub.infra.paths import LOG_DIR
...
def setup_logging(
    ...
    Args:
        ...
        log_dir: Log directory (defaults to ~/.hei-datahub/logs/)
...
def get_logger(name: str = "hei_datahub") -> logging.Logger:
    """
...
def log_pull_update(success: bool, files_changed: int = 0, error: Optional[str] = None):
    """Legacy compatibility - no-op (no PR functionality)."""
    pass
