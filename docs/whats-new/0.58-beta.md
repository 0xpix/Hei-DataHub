...
- [Implementation Details](../../DESKTOP_INTEGRATION.md) - Architecture and design
- [CLI Command Update](../../CLI_COMMAND_UPDATE.md) - What changed
...
- **Entry points:** Both `hei-datahub` and `mini-datahub` commands work (`mini-datahub` will be deprecated soon)
...
### Updated Guides
- [README](../../README.md) — Updated with UV installation
