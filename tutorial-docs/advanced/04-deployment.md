...
[project.scripts]
hei-datahub = "hei_datahub.__main__:main"
hei = "hei_datahub.__main__:main"
...
a = Analysis(
    ...
    binaries=[],
    datas=[
        ('src/hei_datahub/ui/styles', 'hei_datahub/ui/styles'),
        ('src/hei_datahub/config', 'hei_datahub/config'),
    ],
    hiddenimports=[
        'textual',
        'pydantic',
...
jobs:
  test:
    ...
    steps:
      ...
      - name: Run tests
        run: |
          pytest tests/ --cov=hei_datahub --cov-report=xml
...
**File:** `src/hei_datahub/version.py`
...
# Update version.py
echo "__version__ = \"$VERSION\"" > src/hei_datahub/version.py
echo "__app_name__ = \"Hei-DataHub\"" >> src/hei_datahub/version.py

# Update pyproject.toml
sed -i "s/version = .*/version = \"$VERSION\"/" pyproject.toml

# Commit
git add src/hei_datahub/version.py pyproject.toml
