...
**File:** `src/hei_datahub/logging_config.py`
...
```python
from hei_datahub.logging_config import setup_logging
...
```
> /home/user/src/hei_datahub/services/search.py(12)search_datasets()
-> results = perform_search(query)
(Pdb)
```
...
python -m memory_profiler -m hei_datahub
```
...
pytest tests/ --cov=hei_datahub --cov-report=html
