...
**File:** `src/hei_datahub/services/suggestion_service.py`
...
**File:** `src/hei_datahub/ui/views/edit_dataset.py`
...
**File:** `src/hei_datahub/ui/views/dataset_details.py`
...
**File:** `src/hei_datahub/ui/views/statistics.py`
...
class StatisticsScreen(Screen):
    ...
    def on_mount(self) -> None:
        ...
        from hei_datahub.infra.index import get_connection
...
class HomeScreen(Screen):
    ...
    def action_open_statistics(self) -> None:
        ...
        from hei_datahub.ui.views.statistics import StatisticsScreen
...
**File:** `src/hei_datahub/ui/styles/default.tcss`
...
**File:** `src/hei_datahub/ui/widgets/tag_pill.py`
...
```python
from hei_datahub.ui.widgets.tag_pill import TagPill
...
**File:** `src/hei_datahub/services/recent_datasets.py`
...
**File:** `src/hei_datahub/app/runtime.py`

```python
from hei_datahub.services.recent_datasets import RecentDatasetsService
from hei_datahub.infra.paths import STATE_DIR
