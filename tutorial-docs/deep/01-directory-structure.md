...
├── __main__.py       # Entrypoint (python -m hei_datahub)
...
```python
from hei_datahub.app.runtime import get_app
...
```python
from hei_datahub.auth.credentials import get_auth_store
...
```python
from hei_datahub.cli.update_manager import UpdateManager
...
```python
from hei_datahub.core.models import Dataset, Person
...
```python
from hei_datahub.core.queries import SearchQuery
...
```python
from hei_datahub.core.rules import normalize_id
...
```python
from hei_datahub.core.errors import DatasetNotFoundError
...
```python
from hei_datahub.infra.store import read_dataset, write_dataset
...
```python
from hei_datahub.infra.paths import DATA_DIR, DB_PATH
...
```python
from hei_datahub.services.search import SearchService
...
```python
from hei_datahub.services.sync import SyncService
...
```python
from hei_datahub.ui.views.cloud_files import CloudFilesScreen
...
```python
from hei_datahub.ui.widgets.autocomplete import AutocompleteWidget
...
```python
from hei_datahub.utils.async_utils import debounce
...
```python
from hei_datahub.utils.text import truncate
...
### `__main__.py`
**What:** Entrypoint for `python -m hei_datahub`
