...
class TestAuthDoctor:
    ...
    @patch("hei_datahub.infra.config_paths.get_config_path")
    @patch("hei_datahub.auth.credentials.get_auth_store")
    @patch("hei_datahub.services.webdav_storage.WebDAVStorage")
...
def test_full_reindex_flow(tmp_path):
    ...
    from hei_datahub.infra.store import write_dataset
...
def test_windows_filename_sanitization(input, expected):
    ...
    from hei_datahub.infra.platform_paths import sanitize_windows_filename
...
pytest --cov=hei_datahub tests/

# Generate HTML report
pytest --cov=hei_datahub --cov-report=html tests/
...
-----------------------------------------------------------
hei_datahub/__init__.py                    3      0   100%
hei_datahub/infra/index.py               120     15    88%
hei_datahub/services/search.py            85     20    76%
hei_datahub/ui/views/home.py             200    150    25%
-----------------------------------------------------------
TOTAL                                     408    185    55%
```
