...
**File:** `src/hei_datahub/cli/main.py`
...
**File:** `src/hei_datahub/auth/setup.py`
...
def handle_doctor(args):
    ...
    from hei_datahub.infra.paths import DATA_DIR, DB_PATH, CONFIG_DIR
...
def test_reindex_command():
    ...
    result = subprocess.run(
        [sys.executable, "-m", "hei_datahub.cli.main", "reindex"],
        capture_output=True,
        text=True,
    )
...
def test_auth_status_no_config():
    ...
    result = subprocess.run(
        [sys.executable, "-m", "hei_datahub.cli.main", "auth", "status"],
        capture_output=True,
        text=True,
    )
