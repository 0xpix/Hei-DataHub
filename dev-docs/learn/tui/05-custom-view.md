...
**File:** `src/mini_datahub/ui/views/stats.py`
...
**File:** `src/mini_datahub/ui/styles/stats.tcss`
...
class HomeScreen(Screen):
    ...
    def action_show_stats(self) -> None:
        ...
        from mini_datahub.ui.views.stats import StatsScreen
...
**TCSS File:** `src/mini_datahub/ui/styles/stats.tcss`
...
**File:** `src/mini_datahub/ui/views/home.py` (Lines 913-930)
...
**File:** `src/mini_datahub/ui/views/settings.py` (Lines 1-60)
...
1. Create `src/mini_datahub/ui/views/stats.py` with the complete example above

2. Create `src/mini_datahub/ui/styles/stats.tcss` with the CSS above
