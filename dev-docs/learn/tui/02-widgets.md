...
**File:** `src/mini_datahub/ui/widgets/dataset_card.py`
...
**File:** `src/mini_datahub/ui/styles/dataset_card.tcss`
...
```python
from mini_datahub.ui.widgets.dataset_card import DatasetCard
...
**File:** `src/mini_datahub/ui/views/details.py`
...
class DatasetDetailsScreen(Screen):
    ...
    def action_edit(self):
        """Open edit screen."""
        from mini_datahub.ui.views.edit import EditDatasetScreen
...
class HomeScreen(Screen):
    def on_data_table_row_selected(self, event: DataTable.RowSelected):
        ...
        # Open details screen
        from mini_datahub.ui.views.details import DatasetDetailsScreen
...
**File:** `src/mini_datahub/ui/views/home.py` (Lines 600-650)
...
**File:** `src/mini_datahub/ui/widgets/status_bar.py`
