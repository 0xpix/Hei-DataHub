...
**File:** `src/mini_datahub/ui/views/home.py` (Lines 380-410)
...
**File:** `src/mini_datahub/ui/keybindings.py`
...
```python
from mini_datahub.ui.keybindings import bind_actions_from_config
...
def _build_bindings_from_config() -> list[Binding]:
    ...
    try:
        from mini_datahub.ui.keybindings import (
...
1. Edit `src/mini_datahub/ui/views/home.py`
