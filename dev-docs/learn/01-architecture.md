...
- `widgets/command_palette.py` — Command palette (like VS Code's `Ctrl+P`)
- `theme.py` — Color schemes and styling
- `keybindings.py` — Keyboard shortcut mapping
...
**Location**: `src/mini_datahub/services/`
...
**Location**: `src/mini_datahub/core/`
...
**Location**: `src/mini_datahub/infra/`
...
```python
# services/search.py
from mini_datahub.core.queries import parse_query
...
```python
# services/search.py
from mini_datahub.infra.index import search_fts
...
```bash
src/mini_datahub/ui/views/home.py         # Layer?
src/mini_datahub/services/search.py       # Layer?
src/mini_datahub/core/models.py           # Layer?
src/mini_datahub/infra/db.py              # Layer?
```
