...
from mini_datahub.infra.config_paths import get_db_path
...
class AddDataScreen(Screen):
    def action_save(self) -> None:
        ...
        from mini_datahub.services.catalog import generate_id, save_dataset
...
**File:** `src/mini_datahub/services/catalog.py`

```python
from typing import Tuple, Optional
from mini_datahub.core.models import DatasetMetadata
from mini_datahub.infra.store import validate_metadata, write_dataset
...
def generate_id(base_name: str) -> str:
    ...
    from mini_datahub.infra.store import make_unique_id
...
**File:** `src/mini_datahub/infra/store.py` (validation logic)
...
**File:** `src/mini_datahub/infra/store.py`

```python
import yaml
from pathlib import Path
from mini_datahub.infra.config_paths import get_datasets_dir
